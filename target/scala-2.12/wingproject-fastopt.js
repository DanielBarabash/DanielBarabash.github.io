...
Object.defineProperty($c_Lexample_Config$.prototype, "rotationSpeed", {
  "get": (function() {
    return this.$$js$exported$prop$rotationSpeed__O()
  }),
  "set": (function(arg$1) {
    var prep0 = $uD(arg$1);
    this.$$js$exported$prop$rotationSpeed__D__O(prep0)
  }),
  "configurable": true
});
var $d_Lexample_Config$ = new $TypeData().initClass({
  Lexample_Config$: 0
}, false, "example.Config$", {
  Lexample_Config$: 1,
  O: 1
});
$c_Lexample_Config$.prototype.$classData = $d_Lexample_Config$;
var $n_Lexample_Config$ = (void 0);
function $m_Lexample_Config$() {
  if ((!$n_Lexample_Config$)) {
    $n_Lexample_Config$ = new $c_Lexample_Config$().init___()
  };
...
$e.config = $m_Lexample_Config$();
$m_Lexample_Main$().main__AT__V($makeNativeArrayWrapper($d_T.getArrayOf(), []));
}).call(this);
//# sourceMappingURL=wingproject-fastopt.js.map
